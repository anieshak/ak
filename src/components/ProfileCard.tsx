...
export default function ProfileCard() {
  return (
    <div className="bg-white shadow-xl flex flex-col md:flex-row gap-4 items-center rounded-md">
      {/* Left: Image Section */}
      ...
      <div className="flex-1 flex flex-col justify-center p-10 md:w-124 sm:w-full">
        <div>
